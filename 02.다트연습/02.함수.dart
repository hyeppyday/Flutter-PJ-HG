...
void main(List<String> args) {
  ...
  showTxt('다음 이순신 시리즈가 있다면 추천하는 배우는 공유다!');
  showTxt('공유의 취미는${recomActor['공유']?['취미']}다! 사는곳은 ${recomActor['공유']?['사는곳']}다! 공유의 자동차는${recomActor['공유']?['자동차']??"정보없음"}이다!');

  // 익명함수를 만들어서 특정함수에 값으로 전달한다
  // 익명함수는 callback함수와 특성이 비슷함 (나중에 실행하려고 대기중)
